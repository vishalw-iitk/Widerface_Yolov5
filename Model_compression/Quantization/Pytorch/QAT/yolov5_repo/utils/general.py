...
from dts.Model_compression.Quantization.Pytorch.QAT.yolov5_repo.utils.google_utils import gsutil_getsize
from dts.Model_compression.Quantization.Pytorch.QAT.yolov5_repo.utils.metrics import box_iou, fitness
from dts.Model_compression.Quantization.Pytorch.QAT.yolov5_repo.utils.torch_utils import init_torch_seeds
...
def strip_optimizer(model, f='best.pt', s=''):  # from utils.general import *; strip_optimizer()
    ...
    # Need to check : Here the model will have no requires_grad paramater as it was detached in torch_utils
