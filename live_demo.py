...
sys.path.append('./Worked_on_yolov5/yolov5/')
...
sys.path.append('./../')
from dts.Model_performance.Inference_results_store.Quantization.Pytorch.infer_pyt import quantized_load
...
def run(weights='yolov5s.pt',  # model.pt path(s)
    ...
    if pt:
        if pyt_quantized:
            ...
            print("**************Pytorch Quantized model loaded************")
        else:
...
def parse_opt():
    ...
    parser.add_argument('--pyt-quantized', action='store_true', help = 'To use the quantized model') 
    parser.add_argument('--cfg', type=str, default='Worked_on_yolov5/yolov5/models/yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='Worked_on_yolov5/yolov5/data/hyps/hyp.scratch.yaml', help='hyperparameters path')
